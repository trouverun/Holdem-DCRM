...
BET_BUCKETS = np.array([0.75, 1, 1.5, 2])                   # Which bet sizes are considered (specified as % of the pot)


# ---------------------------------------- CLIENT ----------------------------------------
CLIENT_SAMPLES_BATCH_SIZE = 512#1024*2                               # Batch size for sampled regrets
